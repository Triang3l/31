...
abForceInline D3D12_CPU_DESCRIPTOR_HANDLE abGPUi_D3D_HandleStore_GetCPUDescriptorHandle(const abGPU_HandleStore *store, unsigned int handleIndex) {
...
abForceInline D3D12_GPU_DESCRIPTOR_HANDLE abGPUi_D3D_HandleStore_GetGPUDescriptorHandle(const abGPU_HandleStore *store, unsigned int handleIndex) {
...
abForceInline D3D12_CPU_DESCRIPTOR_HANDLE abGPUi_D3D_SamplerStore_GetCPUDescriptorHandle(const abGPU_SamplerStore *store, unsigned int samplerIndex) {
	D3D12_CPU_DESCRIPTOR_HANDLE handle = store->i_cpuDescriptorHandleStart;
	handle.ptr += samplerIndex * abGPUi_D3D_SamplerStore_DescriptorSize;
	return handle;
}
abForceInline D3D12_GPU_DESCRIPTOR_HANDLE abGPUi_D3D_SamplerStore_GetGPUDescriptorHandle(const abGPU_SamplerStore *store, unsigned int samplerIndex) {
	D3D12_GPU_DESCRIPTOR_HANDLE handle = store->i_gpuDescriptorHandleStart;
	handle.ptr += samplerIndex * abGPUi_D3D_SamplerStore_DescriptorSize;
	return handle;
}
